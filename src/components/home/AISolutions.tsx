...
const solutions = [
  {
    icon: "🧘",
    title: "AI-Generated Meditation & Psychotherapy",
    desc: "Personalized meditation scripts, narration voices, and background music — all dynamically generated by AI to match your emotional state.",
  },
  {
    icon: "🔄",
    title: "Dynamic Meditation Sequences",
    desc: "Intelligently crafted sequences that balance sympathetic and parasympathetic nervous system activity for optimal relaxation and recovery.",
  },
  {
    icon: "🧠",
      ...
      <div className="mx-auto max-w-[var(--max-width)]">
        <FadeIn className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-[560px] text-[17px] leading-relaxed text-text-secondary">
            Cutting-edge generative AI transforms biometric data into
